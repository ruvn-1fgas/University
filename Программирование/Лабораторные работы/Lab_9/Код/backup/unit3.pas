...
procedure merge_sort(source, dest, tmp1, tmp2: String);
const
 chunk_size = 1166886;//131072;           //В 21 раз меньше max_n, желательно ровно в 21, иначе может незначительно увеличиться время сортировки, либо сортировка будет с ошибкой
var
 i, j, cnt, size : Int64;
